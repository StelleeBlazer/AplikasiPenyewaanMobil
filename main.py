...
class Login:
    def add_booking_user(Self, booking):
        Self.logged_in_user.booking_user.append(booking)
        mobil_index = booking.booking_mobil_index
        mobil = Self.List_Mobil[mobil_index]
        ...
        while True:
            ...
            if pilihan == "1" or pilihan.lower() == "masuk" or pilihan.lower() == "login":
                if Self.login():
                    ...
                    if Self.logged_in_user.username == user1.username:
                        Self.user_menu()
    ...
    def user_menu(Self):
        ...
        while True:
            ...
            while menu == 0 :
                ...
                print ("7. Logout")
                print (List_Mobil[0].sewa_mobil) 
                print (List_Mobil[0].plat_nomor) 
                ...
                if menu == 1 :
                    ...
                    if len(Self.logged_in_user.booking_user) == 0:
                        print ("Tidak Ada Bookingan Yang Bisa Di Batalkan Saat Ini ")
                        menu = 0
                        
                    else:
                        x=1
                        for booking in Self.logged_in_user.booking_user:
                            print ("=============================================================")
                            print("Booking No: ", x)
                            x = x+1
                        ...
                        if len(booking_id_check) == 0:
                            ...
                            if pesan.lower() == "y" :
                                print (f"Bookingan Atas Nama: {Self.logged_in_user.username}")
                                print ("Dengan No Hp: ",Self.logged_in_user.booking_user[booking_id_check-1].booking_no_hp)
                                print ("Dengan Lama Peminjaman: ",Self.logged_in_user.booking_user[booking_id_check-1].booking_waktu)
                                print ("Dengan Tagihan Sebesar: ",Self.logged_in_user.booking_user[booking_id_check-1].booking_harga)
                                print ("Dengan Tagihan Sebesar: ",Self.logged_in_user.booking_user[booking_id_check-1].booking_bayar)
                                print ("Brand Mobil Yang Di Booking : ",Self.logged_in_user.booking_user[booking_id_check-1].booking_mobil_brand)
                                print ("Model Mobil Yang Di Booking : ",Self.logged_in_user.booking_user[booking_id_check-1].booking_model_mobil)
                                print ("Dengan Plat Nomor Mobil: ",List_Mobil[Self.logged_in_user.booking_user[booking_id_check-2].booking_mobil_index].plat_nomor) 
                                List_Mobil[Self.logged_in_user.booking_user[booking_id_check-1].booking_mobil_index-1].sewa_mobil = True
                                print (Self.logged_in_user.booking_user[booking_id_check-1].booking_mobil_index)
                                print (List_Mobil[Self.logged_in_user.booking_user[booking_id_check-2].booking_mobil_index].sewa_mobil) 
                                Self.logged_in_user.booking_user.pop(booking_id_check-1)
                    ...
                    if Self.logged_in_user.booking_user:
                        print ("=============================================================")
                        ...
                        for booking in Self.logged_in_user.booking_user:
                            ...
                            print("Dengan No Hp: ", booking.booking_no_hp)
                            print("Dengan Lama Peminjaman: ", booking.booking_waktu)
                            print("Dengan Tagihan Sebesar: ", booking.booking_harga)
                            print("=============================================================")
                    else:
                        print ("=============================================================")
